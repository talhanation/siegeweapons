...
public class SiegeTowerItem extends Item {

    public SiegeTowerItem(Properties properties) {
        super(properties);
    }
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level level, Player player,
        ...
        if (hitresult.getType() == HitResult.Type.BLOCK) {
            SiegeTowerEntity entity = new SiegeTowerEntity(ModEntityTypes.SIEGE_TOWER.get(), level);
